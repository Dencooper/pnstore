                    ...
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="/" target="_blank">
                                <h1 class="text-primary mb-0">PN Store</h1>
                                <p class="text-secondary mb-0">@pnstore</p>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <p>Tác giả: PN Store</p>
                            <p>Website: <a href="#" target="_blank"> PN CSKH</a></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="" target="_blank"><i
                                    class="fas fa-copyright text-light me-2"></i>DenCooper</a>, All right
                            reserved.</span>
                    </div>
                </div>
            </div>
